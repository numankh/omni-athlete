...
If the question does not seem related to the database, just return "I don't know" as the answer. Here is the input:
    ...
    data_paths = {
        "workouts": (str(export_dir / "export_workouts.csv"), "sqlite:///workouts.db", "workouts"),
        "sleep": (str(export_dir / "export_sleep.csv"), "sqlite:///sleep.db", "sleep"),
        "exerciseTime": (str(export_dir / "export_exercise_time.csv"), "sqlite:///exerciseTime.db", "exerciseTime"),
    }
